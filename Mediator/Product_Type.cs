...
namespace Mediator
{
    public partial class Product_Type : Form
    {
        ...
        void clear_all()
        {
            try
            {
                // TODO: This line of code loads data into the 'MediatorDataSet.Products' table. You can move, or remove it, as needed.
                this.products_TypesTableAdapter.Fill(this.MediatorDataSet.Products_Types);

                product_type_nameTextBox.Clear();
                product_type_detailsTextBox.Clear();
        ...
        {
            // TODO: This line of code loads data into the 'mediatorDataSet.Products_Types' table. You can move, or remove it, as needed.
            this.products_TypesTableAdapter.Fill(this.MediatorDataSet.Products_Types);
        ...
        private void Search_textBox_TextChanged(object sender, EventArgs e)
        {
            try
            {
                this.products_TypesTableAdapter.Search(this.MediatorDataSet.Products_Types, Search_textBox.Text);
            }
            catch (Exception errortext)
            {
                LoginInfo.log(" حدث خطأ فى " + this.Text + " " + this.Name.ToString() + " " + errortext.ToString());
        ...
        private void add_btn_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (!string.IsNullOrEmpty(product_type_nameTextBox.Text) && !string.IsNullOrWhiteSpace(product_type_nameTextBox.Text))
                {

                    this.products_TypesTableAdapter.Insert(product_type_nameTextBox.Text, product_type_detailsTextBox.Text);
                ...
                if (!string.IsNullOrEmpty(product_type_nameTextBox.Text) && !string.IsNullOrWhiteSpace(product_type_nameTextBox.Text))
                {
                    ...
                    if (result == DialogResult.Yes)
                    {
                        ...
                        if (product != null)
                        {
                            ...
                            this.products_TypesTableAdapter.Update(product_type_nameTextBox.Text,  product_type_detailsTextBox.Text, id);
        ...
        private void delete_btn_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (result == DialogResult.Yes)
                {
                    ...
                    {
                        int id = int.Parse(product.Cells[0].Value.ToString());
                        this.products_TypesTableAdapter.Delete(id);
