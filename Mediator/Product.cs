...
namespace Mediator
{
    public partial class Product : Form
    {
        ...
        private void Search_textBox_TextChanged(object sender, EventArgs e)
        {
            try
            {
                this.productsTableAdapter.Search(this.MediatorDataSet.Products, Search_textBox.Text);
            }
            catch (Exception errortext)
            {
                LoginInfo.log(" حدث خطأ فى " + this.Text + " " + this.Name.ToString() + " " + errortext.ToString());
        ...
        private void add_btn_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (!string.IsNullOrEmpty(product_nameTextBox.Text) && !string.IsNullOrWhiteSpace(product_nameTextBox.Text))
                {

                this.productsTableAdapter.Insert(product_nameTextBox.Text, product_detailsTextBox.Text);
                ...
                if (!string.IsNullOrEmpty(product_nameTextBox.Text) && !string.IsNullOrWhiteSpace(product_nameTextBox.Text))
                {
                    ...
                    if (result == DialogResult.Yes)
                    {
                        ...
                        if (product != null)
                        {
                            ...
                            this.productsTableAdapter.Update(product_nameTextBox.Text,  product_detailsTextBox.Text, id);
        ...
        private void delete_btn_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (result == DialogResult.Yes)
                {
                    ...
                    {
                        int id = int.Parse(product.Cells[0].Value.ToString());
                        this.productsTableAdapter.Delete(id);
